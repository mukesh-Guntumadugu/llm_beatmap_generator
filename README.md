...
- **Weights:** You must manually download the MuMu-LLaMA repository and weights from the internet and place them in the root directory under a folder called `MuMu-LLaMA/`. The codebase expects the inner path to be `MuMu-LLaMA/`.
