...
# ── Static system instruction now lives in src/beatmap_prompt.py ─────────────
# Imported at the top of this file as _BEATMAP_SYSTEM_INSTRUCTION
...
def process_full_song(audio_path: str, level: str = "Hard", mode: str = "full", model_name: str = "gemini-2.0-flash-001"):
    ...
    if level.lower() == "Hard":
        prompt_text = (
            ...
            "IMPORTANT: Separate measures with a comma ',' on its own line/entry. A measure usually has 4 / 8 / 12 / 16 beats.\n"
